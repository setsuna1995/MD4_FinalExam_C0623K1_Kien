...
function editEmployee() {
    ...
    async function tempContainer() {
        try {
            ...
            document.getElementById("edit").innerHTML = employeeContainer(departmentData);
        } catch (error) {
    ...
    function employeeContainer(departmentData) {
        ...
        return `
            <form>
                ...
                <button type="submit" class="btn btn-primary" onclick="edit(id)">Save</button>
...
function edit(id) {
    ...
    axios.put(`http://localhost:8080/api/employees/${id}`, employee).then((response) => {
